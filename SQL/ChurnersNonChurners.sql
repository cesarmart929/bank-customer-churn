...
SELECT
  100 * AVG(CASE WHEN Exited = 1 THEN IsActiveMember ELSE NULL END) AS pctg_active_churned,
  100 * AVG(CASE WHEN Exited = 0 THEN IsActiveMember ELSE NULL END) AS pctg_active_notchurned
FROM
  `coherent-window-466113-k2.bank_churn.customers`;
